-- This file contains generic keybindings declarations. These can be applied to widgets and stuff
...
globalkeys = awful.util.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () require("bar").screen_widgets[mouse.screen].promptbox:run() end),

    awful.key({ modkey }, "x",
              function ()
                  awful.prompt.run({ prompt = "Run Lua code: " },
                  require("bar").screen_widgets[mouse.screen].promptbox.widget,
                  awful.util.eval, nil,
...
function apply()
	...
	window_mgmt = require("window_mgmt")
	window_mgmt.all_window_properties.keys = clientkeys
	window_mgmt.all_window_properties.buttons = clientbuttons
end
